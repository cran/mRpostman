# Canned-transport helpers: mock the transfer (curl_perform, the package's
# per-connection wrapper around libcurl) so the command layer (request
# assembly, retry, error translation) is testable without a server.
